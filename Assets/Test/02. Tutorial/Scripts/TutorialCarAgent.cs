...
public class TutorialCarAgent : Agent
{
    ...
    {
        this.gameObject.transform.localPosition = new Vector3(Random.Range(-8f, 8f), 0f, Random.Range(-8f, 8f));
        this.gameObject.transform.rotation = Quaternion.Euler(0f, Random.Range(0f, 360f), 0f);
        carRigidbody.velocity = Vector3.zero;
        
        goal.transform.localPosition = new Vector3(Random.Range(-9f, 9f), 0f, Random.Range(-9f, 9f));
    }
